...
public class RealEstateCalculator {
    public static void main(String[] args) {
        ...
        int propertyPrice = 0;
        int numberOfBedrooms,garageSpots, numberOfBedroomPrice;
        ...
        switch(houseType){
            ...
            default: propertyPrice=95000;
        }
        System.out.println("How many bedrooms do you have?");
        numberOfBedrooms=scan.nextInt();
        numberOfBedroomPrice=numberOfBedrooms*30000;
        propertyPrice +=numberOfBedroomPrice;
        ...
        if(backyard){
            switch(houseType) {
                case "Condo":
                    System.out.println("Backyard is not available for condo!");break;
                case "Townhouse":propertyPrice +=5000;break;
                default:propertyPrice+= 5000;}}
        ...
        if(garage){propertyPrice += garageSpots*20000;}

        System.out.println("How close is metro station?");
        metroAccessibility=scan.nextFloat();
        if(metroAccessibility<=1){propertyPrice+=10000;}else{propertyPrice+=5000;}
        System.out.println("How close is highway?");
        highwayAccessibility=scan.nextFloat();
        if(highwayAccessibility<=1){propertyPrice +=15000;}
        else if(highwayAccessibility<=5) {propertyPrice+=8000;} else{propertyPrice+=4000;}

        System.out.println("What's the rating of nearest school?");
        schoolScore=scan.nextFloat();
        if(schoolScore>=8){propertyPrice += 45000;}else if(schoolScore<8&&schoolScore>=4){propertyPrice +=20000;}else{propertyPrice+=5000;}
...
/*
his program should work with 3 house types:
