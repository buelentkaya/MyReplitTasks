...
double laptopPrice=0;
        ...
        if(screenSize==13.3){laptopPrice+=200;}else if(screenSize==15.0){laptopPrice+=300;}
        else{laptopPrice +=400;}
        ...
        switch(cpuType){
            ...
            default :laptopPrice+=350;}

        System.out.println("Select RAM size:");
        int rem=scan.nextInt();
        laptopPrice+=(rem/4)*50;
        ...
        switch (storageType){
            case "HDD": laptopPrice +=(memorySize/500)*50 ; break;
            default:laptopPrice+=(memorySize/500)*100;}

        System.out.println("Enter screen resolution:");
        String screenResolution=scan.next();
        switch(screenResolution){
            case "4K":laptopPrice +=200; break;
            default:laptopPrice +=100;}
        scan.close();
